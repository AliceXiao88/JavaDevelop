			...
			<div id="header">
				<div id="logo">
					<br> <br> <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font
									color="#FFFFFF" size="+2"
									face="Georgia, Times New Roman, Times, serif"> Online
										Fraud Detection in E-Shopping <br>
								</font></strong>
				</div>
			</div>
			<!-- /header -->
						...
						<tr bgcolor="#CC3300">
							<td width="610" bgcolor="#FBF7E1" valign="top"><br> <br>
										<br>
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font
											color="#FF0000" size="+1" face="Courier New"><strong>All
													Sellers</strong></font> <br> <br> <br>
														<form name="f" action="off_search.jsp" method="post"
															...
															<table bgcolor="#FFFFFF" width="700" border="0">
																<tr bgcolor="#E4E4F1">
																	...
																	<td align="center"><font color="#110022"><strong>Phone
																				No</strong></font></td>
																	<td align="center"><font color="#110022"><strong>Email
																				Id</strong></font></td>
																...
																<tr bgcolor="#FFFFCC">
																	...
																	<td align="center"><strong><font
																			color="#6300C6"><%=ph%> </font></strong></td>
																	<td align="center"><strong><font
																			color="#6300C6"> <%=email%>
																		</font></strong></td>
																	<td align="center"><strong><font
